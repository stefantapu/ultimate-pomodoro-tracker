-- Count interrupted focus progress in analytics and XP.
-- Full pomodoro count still tracks only completed focus sessions.
...
BEGIN
    IF NEW.mode = 'focus'
       AND NEW.status IN ('completed', 'interrupted')
