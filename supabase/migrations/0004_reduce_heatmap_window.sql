-- Reduce analytics heatmap window from ~1 year to ~6 months.
-- Previous query used [today - 365 days, today] (366 points).
-- New query uses [today - 182 days, today] (183 points, ~half).
...
BEGIN
    ...
    -- 5. Heatmap Data (~half of prior window)
